-- بيانات تجريبية لنظام عدد اللاعبين والمشاركين

-- تحديث الدوريات الموجودة بأنواعها
UPDATE leagues SET 
  league_category = 'professional',
  max_roster_size = 18,
  max_starters = 11,
  max_substitutes = 7,
  roster_requirements = '{"min_goalkeepers": 2, "min_defenders": 4, "min_midfielders": 3, "min_forwards": 2}'
WHERE id = 1; -- كأس البطولة المصرية (دوري المحترفين)
...
UPDATE leagues SET 
  ...
  max_substitutes = 7,
  roster_requirements = '{"min_goalkeepers": 2, "min_defenders": 4, "min_midfielders": 3, "min_forwards": 2}'
WHERE id = 2; -- دوري المحترفين

-- إضافة دوري أبطال جديد (14 لاعب)
INSERT INTO leagues (
  name, description, country, season, league_type, max_teams,
  league_category, max_roster_size, max_starters, max_substitutes,
  status, start_date, end_date, match_duration, 
  prize_first, prize_second, prize_third, admin_id
) VALUES (
  'دوري الأبطال المصري 2024',
  'دوري الدرجة الثانية للأندية الصاعدة - نظام مخفض',
  'مصر',
  '2024/2025',
  'league',
  12,
...
-- المشرفون (Admins)
INSERT INTO league_participants (league_id, participant_type, user_id, person_name, role_title, email, phone) VALUES 
...
-- الحكام (Referees)
INSERT INTO league_participants (league_id, participant_type, user_id, person_name, role_title, email, phone, license_number) VALUES 
  ...
  (1, 'referee', NULL, 'أحمد حسن', 'حكم وطني - حكم مساعد', 'ahmed.hassan@procoach.com', '+201234567803', 'REF-EGY-004'),
  (1, 'referee', NULL, 'محمود البناني', 'حكم وطني - حكم رابع', 'mahmoud.banany@procoach.com', '+201234567804', 'REF-EGY-005');

-- المدربون (Coaches)
INSERT INTO league_participants (league_id, participant_type, user_id, person_name, role_title, team_id, email, phone, license_number) VALUES 
  ...
  (1, 'coach', NULL, 'أحمد حسن', 'المدرب الرئيسي للزمالك', 2, 'ahmed.hassan@zamalek.com', '+201234567822', 'COACH-EGY-002'),
  (1, 'assistant_coach', NULL, 'طارق مصطفى', 'مساعد المدرب للزمالك', 2, 'tarek.mostafa@zamalek.com', '+201234567823', NULL),
...
INSERT INTO league_participants (league_id, participant_type, user_id, person_name, role_title, team_id, email, phone) VALUES 
  ...
  (1, 'team_manager', NULL, 'أحمد حسن', 'مدير الكرة لبيراميدز', 3, 'ahmed.hassan@pyramids.com', '+201234567812'),
  (1, 'team_manager', NULL, 'طارق مصطفى', 'مدير الكرة للإسماعيلي', 4, 'tarek.mostafa@ismaily.com', '+201234567813');
